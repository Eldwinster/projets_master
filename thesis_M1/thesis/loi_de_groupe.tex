...
\textbf{ce lemme garantit l'unicité et l'existence d'une droite qui passe par deux points
de la courbe}
\begin{lemme}
    \label{lem:lemme2}
...
Ainsi munie de la droite et de la tangente, on a tous les armes pour se confronter aux
différentes situation.
\[
\begin{proposition}
