...
% point, appelé point à l'infini que l'on note $O$. Ainsi dans l'espace projectif deux droites parallèles s'intersectent en
...
% % On obtient donc l'ensemble $\mathbb{P}^1 = K \cup O$, avec $O = \left[ 1,0 \right] $, le point à
% % l'infini. 
