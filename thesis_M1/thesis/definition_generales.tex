...
% \begin{definition}
%     Soit $L$ un corps satisfaisant $K \subset L \subset \overline{K}$. On dit qu'un point
%     $(x,y,z)$ de la courbe est $L$-rationnel, si on a $(x,y,z) = \lambda (x',y',z')$ pour
%     $\lambda \in \overline{K}$ et $(x',y',z') \in \mathbb{P}_{2}(L)$, c'est à dire,
%     à une équivalence projective prés, les coordonnées du point sont dans $L$. 

%     L'ensemble des points rationnel de $E$, noté $E(K)$ est :
% \end{definition}
